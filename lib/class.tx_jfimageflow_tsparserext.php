 ...
 */
class tx_jfimageflow_tsparserext
{
	/**
	...
	function displayMessage(&$params, &$tsObj)
	{
		...
		if (class_exists(t3lib_utility_VersionNumber) && t3lib_utility_VersionNumber::convertVersionNumberToInteger(TYPO3_version) < 4003000) {
			...
			$cssPath = $GLOBALS['BACK_PATH'] . t3lib_extMgm::extRelPath('jfimageflow');
	...
	<div class="typo3-message message-warning">
		<div class="message-header">' . $GLOBALS['LANG']->sL('LLL:EXT:jfimageflow/locallang.xml:extmng.updatermsgHeader') . '</div>
		<div class="message-body">
			' . $GLOBALS['LANG']->sL('LLL:EXT:jfimageflow/locallang.xml:extmng.updatermsg') . '
		</div>
	</div>';
		}
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfimageflow/lib/class.tx_jfimageflow_tsparserext.php']) {
	include_once ($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfimageflow/lib/class.tx_jfimageflow_tsparserext.php']);
}
?>